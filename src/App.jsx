...
export default function App() {
  return (
    <div className="flex h-screen bg-[#020617] text-white font-sans overflow-hidden">
      ...
      <aside className="w-20 border-r border-white/5 flex flex-col items-center py-8 justify-between bg-black/20 backdrop-blur-xl">
      ...
      <main className="flex-1 p-10 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Карточка 1 */}
          <div className="group p-8 bg-white/[0.03] border border-white/10 rounded-[2.5rem] hover:bg-white/[0.06] transition-all duration-500">
            <h3 className="text-xl font-medium mb-4">Список задач</h3>
            <div className="h-32 rounded-2xl bg-black/20 border border-white/5 flex items-center justify-center text-slate-600 italic">
              Контент задач появится завтра...
            </div>
          </div>
      ...
      <div className="absolute bottom-0 left-20 w-[300px] h-[300px] bg-purple-600/10 rounded-full blur-[100px] -z-10"></div>
    </div>
  );
}